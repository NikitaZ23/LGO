...
class JobStore:
    ...
    def normalize_texture_version(
        ...
        return {
            ...
            "target_length_m": version.get("target_length_m", payload.get("target_length_m")),
            "apply_dimensions": version.get("apply_dimensions", payload.get("apply_dimensions", True)),
